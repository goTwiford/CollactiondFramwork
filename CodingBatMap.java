...
public class CodingBatMap {
	...
	// topping1 Given a map of food keys and topping values,
	...
	// mapAB2 Modify and return the given map as follows: if the keys "a" and "b"
	...
	// mapShare Modify and return the given map as follows: if the key "a" has a
	// value,
...
//		the "a" and "b" keys. If both keys are present, append their 
